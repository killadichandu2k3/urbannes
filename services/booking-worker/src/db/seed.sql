...
VALUES
    ...
    ('89c4a2a5-4f47-4f64-bba7-a3c186f18317', 'f1522aa6-a23a-4842-93e5-277d472d8a0a',
     'Dune: Messiah', now() + interval '20 days', now() + interval '20 days' + interval '3 hours', 1323, false, now() - interval '56 days'),
    ...
    ('71baea7a-e086-4e81-9fc5-0b23d41c1a8e', 'f1522aa6-a23a-4842-93e5-277d472d8a0a',
     'The Lord of the Rings: The War of the Rohirrim', now() + interval '60 days', now() + interval '60 days' + interval '3 hours', 1004, false, now() - interval '67 days'),
...
BEGIN
    FOR ev IN SELECT id, venue_id, base_price, created_at FROM events LOOP
        ...
        FOR i IN 1..(3 + (random() * 3)::int) LOOP
            ...
            price := ev.base_price * (0.9 + random() * 0.4);
